...
/**
 * Run the retrieval engine against a realistic mock auth repo and return
...
): { result: RetrievalResult; files: IndexedFile[] } {
  return {
    result: retrieveRelevantFiles(question, mockIndexedFiles, options),
